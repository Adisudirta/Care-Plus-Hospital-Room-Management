                    ...
                    <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">                                                                        
                                    <form action="/reservasi-pasien/{{$room->id}}/{{$patient->id}}" method="POST" class="d-inline">                            
                                        @csrf
                                        <button type="submit" data-bs-toggle="tooltip" data-bs-original-title="Tambahkan pasien ke kamar" class="border-0 bg-transparent">
